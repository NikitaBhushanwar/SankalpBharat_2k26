...
export default function ContactUsPage() {
  return (
    <main className="min-h-screen overflow-x-hidden px-3 sm:px-6 lg:px-8 pt-36 pb-10">
      <div className="w-full max-w-5xl mx-auto overflow-hidden rounded-3xl border border-cyan-500/20 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl p-4 sm:p-7 lg:p-10">
        <div className="mb-8">
          <Link
            href="/"
        ...
        <div className="mb-10 text-center">
          <p className="text-xs font-semibold tracking-[0.2em] uppercase text-cyan-600 dark:text-cyan-300 mb-3">Contact Us</p>
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
          <div className="min-w-0 rounded-2xl border border-border/50 bg-white/80 dark:bg-slate-900/60 dark:backdrop-blur p-5 sm:p-6">
            ...
            <a
              href="mailto:sankalpbharat@stvincentngp.edu.in"
              className="block break-all text-sm sm:text-base text-slate-600 dark:text-slate-300 hover:text-cyan-500 dark:hover:text-cyan-300 transition"
            >
        ...
        <section className="mt-8 sm:mt-10 min-w-0 rounded-2xl border border-border/50 bg-white/80 dark:bg-slate-900/60 dark:backdrop-blur p-4 sm:p-6">
          ...
          <div className="overflow-hidden rounded-xl border border-cyan-500/20 bg-slate-950/40">
            <iframe
          ...
          <a
            ...
            className="mt-4 inline-flex h-10 items-center justify-center rounded-xl border border-cyan-500/40 bg-cyan-500/10 px-4 text-sm font-semibold text-cyan-700 dark:text-cyan-300 transition hover:bg-cyan-500/20"
          >
            Open in Google Maps
          </a>
        </section>
