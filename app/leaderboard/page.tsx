...
export default function LeaderboardPage() {
  return (
    <main className="min-h-screen px-4 sm:px-6 lg:px-8 pt-28 pb-10">
      <div className="max-w-7xl mx-auto rounded-3xl border border-emerald-500/20 bg-slate-950/80 backdrop-blur-xl p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white">Leaderboard</h1>
          <p className="text-sm text-slate-400 mt-1">Latest team standings from Sankalp Bharat 2K26.</p>
        </div>
