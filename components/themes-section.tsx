    ...
    <section className="relative py-24 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white uppercase">Core Themes</h2>
        </div>
          ...
          {themes.map((theme) => (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="p-3 rounded-xl bg-black/30 border border-border/40">
                  {theme.icon}
                </div>
              </div>

              <h3 className="text-2xl font-black text-white mb-3">{theme.title}</h3>
