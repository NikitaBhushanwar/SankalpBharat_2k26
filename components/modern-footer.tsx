...
export default function ModernFooter() {
  return (
    <footer className="relative border-t border-gray-200 dark:border-slate-700 mt-20">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                ...
                <a href="mailto:contact@sankalp.com" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  contact@sankalp.com
                </a>
              </li>
              <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                <Phone className="w-4 h-4" />
                <a href="tel:+919876543210" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  +91 9876543210
                </a>
              </li>
              <li className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
