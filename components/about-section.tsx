    ...
    <section id="about" className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black uppercase text-white mb-4">Event Overview</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass-effect rounded-2xl p-8 border border-border/40">
            <h3 className="text-xl font-bold text-white mb-4">Organizers &amp; Host</h3>
          ...
          <div className="glass-effect rounded-2xl p-8 border border-border/40">
            <h3 className="text-xl font-bold text-white mb-4">Objective &amp; Vision</h3>
            <p className="text-muted-foreground leading-relaxed">
