    ...
    <section id="about" className="py-14 sm:py-24 px-4 relative overflow-hidden light-section-tint">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black uppercase text-foreground mb-4">Event Overview</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass-effect light-card rounded-2xl p-8 border border-border/40">
            <h3 className="text-xl font-bold text-foreground mb-4">Organizers &amp; Host</h3>
          ...
          <div className="glass-effect light-card rounded-2xl p-8 border border-border/40">
            <h3 className="text-xl font-bold text-foreground mb-4">Objective &amp; Vision</h3>
            <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="mt-10 text-center">
          <Link
            href="/about-event"
            className="btn-modern inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-black uppercase tracking-wider"
          >
            Learn More
          </Link>
        </div>
