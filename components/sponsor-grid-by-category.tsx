            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-8 lg:gap-10">
              {categorySponsors
                ...
                .map((sponsor) => (
                  <div
                    key={sponsor.id}
                    // Adjusted width: Full on mobile, 340px on small tablets+
                  ...
                  >
                    {/* Featured Star - Adjusted for mobile */}
                    {sponsor.isFeatured && (
                    ...
                    {/* Maximized Logo Area - Responsive Height */}
                    <div className="relative h-40 md:h-56 w-full flex items-center justify-center bg-white/[0.02] rounded-[1.2rem] md:rounded-[2rem] overflow-hidden p-2">
                      ...
                      <img
                        src={sponsor.logoUrl}
                        alt={sponsor.name}
                        // Added rounded and border to logo as requested previously
